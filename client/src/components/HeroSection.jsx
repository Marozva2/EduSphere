            ...
            <div className="col-md-6">
              <div className="hero-content">
                <div className="text-content">
                  ...
                  <p>
                    EduSphere University is not just any ordinary Institution.We
                    are distinctive in our performance and take charge of our
      ...
      <section id="about-us" className="about">
        <div className="container" data-aos="fade-up">
          ...
          <div className="row gy-4">
            ...
            >
              <div
                className="call-us position-absolute"
                style={{ borderRadius: "12px", width: "60%", height: "20%" }}
              >
                <div className="call-us-writing position-absolute">
                  <h2 className="ca" style={{ fontSize: "18px" }}>
                    Call Admissions
                  </h2>
                  <h1 id="h11" style={{ fontSize: "20px", color: "maroon" }}>
                    {" "}
                    020-023 799100
                  </h1>
                </div>
            ...
            >
              <div className="content ps-0 ps-lg-5">
                ...
                <ul>
                  <li>
                    <i className="bi bi-check2-all"></i> Student Centred
                  </li>
                  <li>
                    <i className="bi bi-check2-all"></i> Wholistic Learning
                    Approach
                  </li>
                  <li>
                    <i className="bi bi-check2-all"></i>Best Facilities{" "}
                  </li>
                </ul>
                <p>
                  EduSphere University is not just any ordinary Institution.We
      ...
      <section id="testimonials" className="testimonials section-bg">
        <div className="container" data-aos="fade-up">
          <div className="section-header">
            <h2>Testimonials</h2>
            <h3>
              What do Alumni <span>Say About Us</span>
            </h3>
          </div>
                    ...
                    <div className="col-lg-6">
                      <div className="testimonial-content">
                        <p>
                          ...
                          “The skills I gained from Edusphere were numerous and
                          I can attest that they have helped me transition into
                          the job market seamlessly. Would definitely recommend
                          the institution all time.”
                  ...
                  <div className="row gy-4 justify-content-center">
                    <div className="col-lg-6">
                      <div className="testimonial-content">
                        <p>
                          <i className="bi bi-quote quote-icon-left"></i>
                          “Edusphere is a powerhouse. You won't understand
                  ...
                  <div className="row gy-4 justify-content-center">
                    <div className="col-lg-6">
                      <div className="testimonial-content">
                        <p>
                          <i className="bi bi-quote quote-icon-left"></i>
                          “I went, I studied, I gained confidence, now I lead an
                          entire 5000 employee company. Hail Edusphere”
                          <i className="bi bi-quote quote-icon-right"></i>
                        </p>
                        <h3>Emma Bostian</h3>
                  ...
                  <div className="row gy-4 justify-content-center">
                    <div className="col-lg-6">
                      <div className="testimonial-content">
                        <p>
                          <i className="bi bi-quote quote-icon-left"></i>
                          “The world is yet to see the rise of an education
                          giant. Proud to be a part”
                          <i className="bi bi-quote quote-icon-right"></i>
                        </p>
                        <h3>Talia Mar</h3>
                        <h4>Entrepreneur</h4>
